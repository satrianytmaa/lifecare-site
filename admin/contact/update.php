...
<body>
    ...
    <form method="POST" action="/lifecare-site/process/update_contact.php">
        ...
        <div class="form-wrap">
            ...
            <input type="textarea" name="problem" id="problem" value="<?php echo $row->problem ?>">
        </div>
        <div class="create-action">
                <a class="btn-cancel-a" href="/lifecare-site/process/delete_contact.php?id=<?php echo $row->id_clinic; ?>" onclick="return confirmDelete()">Delete</a>
