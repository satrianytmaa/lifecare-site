    ...
    <main>
      ...
      <div class="landing-support">
        <div class="landing-support-company">
          <img
            src=".././assets/icons/Support/support _ explo.svg"
            alt=""
            class="support support-01"
          />
          <img
            src=".././assets/icons/Support/support _ manter.svg"
            alt=""
            class="support support-02"
          />
          <img
            src=".././assets/icons/Support/support _ rigid 1.svg"
            alt=""
            class="support support-03"
          />
          <img
            src=".././assets/icons/Support/support _ stamp.svg"
            alt=""
            class="support support-04"
          />
          <img
            src=".././assets/icons/Support/support _ towa.svg"
            alt=""
            class="support support-05"
          />
          <img
            src=".././assets/icons/Support/support _ wetransfer.svg"
            alt=""
            class="support support-06"
          />
        </div>
      </div>
      ...
      <div class="landing-us container-enable">
        ...
        <img
          ...
          src=".././assets/images/Items/Pattern.svg"
          alt=""
        />
        <div class="landing-us-wrapper">
          <div class="component-benefit active">
            <img
              src=".././assets/images/Content/Pin.svg"
              alt="Benefits"
              class="benefit-icon"
            />
          ...
          <div class="component-benefit">
            <img
              src=".././assets/images/Content/Support.svg"
              alt="Benefits"
              class="benefit-icon"
            />
            <h4>24/7 Support</h4>
          ...
          <div class="component-benefit">
            <img
              src=".././assets/images/Content/Community.svg"
              alt="Benefits"
              class="benefit-icon"
            />
      ...
      <div class="landing-testimonial container-enable">
        ...
        <div class="landing-testimonial-session">
          <div class="component-testimonial">
            <img
              src=".././assets/images/Content/Testimonial.svg"
              alt="Happy People"
            />
        ...
        <div class="landing-blog-session">
          <div class="component-blog blog-01">
            ...
            <div class="label">
              ...
              ><span class="label-time">6 min read</span>
            </div>
