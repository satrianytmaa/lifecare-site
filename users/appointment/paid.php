    ...
    <div class="user-database user-show container-enable">
        ...
        <div class="card-ui">
                ...
                <div class="card-detail">
                    <div class="name_vaccine"><?php echo $vaccine->name_vaccine ?></div>
                    
                    <div style="display: flex; align-items: center;">
                        <span class="dollar" style="margin-right: 1em;">$</span>
                        <div class="price"><?php echo $vaccine->price ?></div>
                    </div>
                </div>
        ...
        <div class="action-button">
            <button class="btn-delete" onclick="return confirmDelete()">
                <a href="/lifecare-site/process/delete_appointment.php?id=<?php echo $data->id_appointment; ?>">Cancel Appointment?</a>
            </button>
        </div>
    </div>
